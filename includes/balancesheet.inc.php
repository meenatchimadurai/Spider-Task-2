...
$stmt->execute();
$stmt->bind_result($expensenumber, $expensename, $expensedescription, $amount, $created_at);

echo '<table style="width:50%;border:1px solid black">';
echo "<tr><th>ExpenseNumber</th><th>Expense Name</th><th>Description</th><th>Amount</th><th>created_at</th></tr>";
while($stmt->fetch()){
...
<div>
 ...
 Enter Expense Number to be Deleted:<input type="int" name="id" placeholder="Expense Number">
